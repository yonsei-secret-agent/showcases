...
4. source_oracle_abstracted_card renderer 재사용
5. source_mode_only_placebo 조건 추가
6. source_hard_mismatched_abstracted_card selector 구현
7. oracle retrieval upper bound caveat를 report에 자동 기록
8. manipulation check와 leakage audit를 source cards에 enforcing 적용
9. case-level paired matrix 출력
10. paired negative transfer metric 추가
```
